...
module.exports = {
  ...
  onStart: async function ({ api, event, usersData }) {
    try {
      ...
      const background = await loadImage("https://files.catbox.moe/xgiizd.jpg");
      ctx.drawImage(background, 0, 0, width, height);

      // ✅ গোল করে প্রোফাইল বসানো ফাংশন
      ...
      // প্রথম জনের প্রোফাইল
      drawCircleImage(sIdImage, 385, 40, 170);

      // দ্বিতীয় জনের প্রোফাইল
      drawCircleImage(pairPersonImage, width - 213, 190, 170);
