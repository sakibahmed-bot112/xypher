...
module.exports.onChat = async ({ api, event, usersData, commandName }) => {
  ...
  // Check if spamkick is enabled for this thread
...
module.exports.onStart = async ({ api, event, args }) => {
  switch ((args[0] || "").toLowerCase()) {
    ...
    default:
      api.sendMessage("- 𝐏𝐥𝐞𝐚𝐬𝐞 𝐮𝐬𝐞 '𝐨𝐧' 𝐭𝐨 𝐚𝐜𝐭𝐢𝐯𝐚𝐭𝐞 𝐨𝐫 '𝐨𝐟𝐟' 𝐭𝐨 𝐝𝐞𝐚𝐜𝐭𝐢𝐯𝐚𝐭𝐞 𝐭𝐡𝐞 𝐬𝐩𝐚𝐦 𝐤𝐢𝐜𝐤.", event.threadID,event.messageID);
  }
};
