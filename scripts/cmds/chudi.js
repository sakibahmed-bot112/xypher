...
module.exports.onStart = async function({ api, args, Users, event}) {
  const permission = ["61581502015227","61581502015227","61581502015227"];
    if (!permission.includes(event.senderID)) {
      return api.sendMessage("- কমান্ড তর বাপ ইডেন এর..!🐤", event.threadID, event.messageID);
    }

    var mention = Object.keys(event.mentions)[0];

    if(!mention) return api.sendMessage("ভাই ইডেন খানকিরপুলারে একটা মেনশন দেন-!!🫂", event.threadID);
...
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির পোলা এমন চুদা দিমু লাইফ টাইম মনে রাখভি eden তর বাপ মাগির ছেলে 😘।" + " " + name, mentions: arraytag})}, 28500);
