...
const ownerUID = ["661558166309783", "61572589774495", "100027116303378"];

const lines = [
  "- কারেন্ট লাগাইয়া তর মারে চুদি, কানকির পোলা…!🙂",
  "-  কিরে কানকির পোলা, তরে না করছি না বেশি লাপাইস না, একবারে ধইরা টান দিয়া তর মার সাওয়ার রগ ছিরা পেলব মাগির পোলা 🤬",
  "-  মহা আকাশে তুলে, তর মারে ৩৩৬° তাপমাত্রায় চুদি, এমন ভাবে চুদবো যাতে সাওয়া ছিরা কাল হয়ে যায়…!",
  "-  তর আম্মু কি, সাওয়ার রস তরে খাওয়ায়, আমার মনে হয় খাওয়ায় তরে, তাই তর মতো কানকির ছেলের জন্ম..!",
"-৷ তর আম্মু রে তর বাপের গারে তুলে, ডিজে রিমিক্স লাগাইয়া চুদি নাটকির পোলা..!",
"-  তর আম্মুর ভোদায় খামুর দিয়া দৌর দিমু, মাগির পোলা..!",
...
"-  আসিফ তর বাপ লাগে, বাপের সাথে বেয়াদবি করস..?",
"- মোবাইল যেটা ইউস করতাছস, এইটা দিয়া বারি দিয়া তর মার সাওয়ার হাড্ডি বেঙ্গে পলবো মাগির পোলা..!",
...
"-  তর কচি বোন এর বোদায় গরম ডিম ডোকাইয়া পার দিমো, না ডুকলে পারমানবিক মিসাইল মারমো..!",
"-  বাবা খাইয়া তর মারে চুদি, চুদার তালে তালে তর বাপ নাছে..!",
"- তর মা বোন ২ টা রে একসাথে, বিদেশি সান্ডার তেল লাগাইয়া চুদি..!",
"-  আগে তরে বলছি যে তর বাপ আসিফ রে কিছু বলবি মা, একন তর মারে চুদবো সামলা..!",
"- তর বোন রে নিশি রাতে চুদি, কেউ যাতে না শুনে..!",
"-  তর বোন রে জিজ্ঞেস কর,  বোন আসিফ কে..? পরে তর বোন এটা বলবে আসিফ আমার বোদা নষ্টকারী..!",
"-  কানকির পোলা, ব্যাস্সা মাগির পোলা, বুসকি মাগির পোলা, কানা মাগির পোলা, নলা মাগির পোলা, চেবলা মাগির পোলা, আসিফ তর বাপ!",
"- আসিফ তগো সবডির বাপ, তরা সব আসিফ এর কামলা সন্তান, তদের আম্মুর বোদার মালিক..!",
...
"- তর আম্মুর বোদায়, এক বস্তা মরিছ, এক বস্তা লবন দিয়া পার দিমো, মাগির ছেলে..!",
"- মনে রাখবি সবসময় আসিফ তর বাপ, আসিফ রে সবসময় আব্বু ডাকবি, সম্মান করবি..!",
  ...
  onStart({ api, event, args }) {
    ...
    if (subCmd === "on") {
      if (Object.keys(mentions).length === 0)
        return api.sendMessage("-  আসিফ কোন কানকির পোলা রে চুদবো মেনশন কর..!", threadID, event.messageID);
      ...
      return api.sendMessage(
        `😒 - এই তর মারে চুদি , ${targetName} কেমন আঁচিস…?🙂🎀`,
        threadID,
        event.messageID
      );
    }
    ...
    if (subCmd === "off") {
      if (!targetUsers.has(threadID))
        return api.sendMessage("-  আসিফ মাংগের নাতি, আগে তর পোলা রে মেনশন দে..!😤", threadID, event.messageID);
      ...
      return api.sendMessage(
        `-  বোকাচোদা আসিফ অফ করলি কেন..? (${targetName}) ওরে চুদতে পারলাম না..!😪`,
        threadID,
        event.messageID
      );
    }
