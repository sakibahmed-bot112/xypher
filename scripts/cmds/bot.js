...
const prefixes = ["bby", "janu", "babe", "bot", "tonu", "bbu", "jan", "eden"];
...
module.exports = {
  ...
  onChat: async function ({ api, event }) {
    const randomReplies = ["- বলো জান কি করতে পারি তোমার জন্য..!🥹", "- আর কত বার ডাকবা ,শুনছি তো..!😡", "- আম গাছে আম নাই ঢিল কেন মারো, তোমার সাথে প্রেম নাই বেবি কেন ডাকো..!🫣", "- দূরে যা, তোর কোনো কাজ নাই, শুধু 𝗯𝗯𝘆 𝗯𝗯𝘆 করিস..!🙂", "- বার বার ডাকলে লিভ নিব..!😿", "- 𝗕𝗯𝘆 𝗯𝗼𝗹𝗹𝗮 𝗽𝗮𝗽 𝗵𝗼𝗶𝗯𝗼..!😒", "- 𝗕𝗯𝘆 বলে অসম্মান করচ্ছিছ..!😰😿", "- কি বলবি তারাতাড়ি বল..!😊", "- তোর বিয়ে হয় নি 𝗕𝗯𝘆 হইলো কিভাবে..!🙄", "- বস ইডেন এর সাথে ব্যাস্ত আছি..!😒", "- বার বার ডাকলে মাথা গরম হয় কিন্তু..!😒", "- তর কথা বাড়িত কেউ শুনে না, আমি কেন শুনবো..!🙄", "- ভুলে জাও আমাকে জান..!😞", "- আমাকে ডাকলে কিন্তু কিস করে দিব..!🤐", "- অযথা বক বক করিস কেন..!😾", "- তরে সহ্য করতে পারি না..!😿"];
